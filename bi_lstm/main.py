...
train_dataset = NerDataset('/home/rb071/Documents/named-entity-recognition-vietnamese/data/data/covid_train.txt')
vocab = train_dataset.vocab
label = train_dataset.label
val_dataset = NerDataset('/home/rb071/Documents/named-entity-recognition-vietnamese/data/data/covid_test.txt', vocab, label)
...
criterion = criterion = nn.CrossEntropyLoss(ignore_index=model.tag_vocab[PAD])
