...
if __name__ == '__main__':
    model = CRF_NER.load('/home/rb071/Documents/named-entity-recognition-vietnamese/crf/model.crfsuite')
    f1_score = evaluate(model, '/home/rb071/Documents/named-entity-recognition-vietnamese/data/data/covid_test.txt')
    print(f1_score)
